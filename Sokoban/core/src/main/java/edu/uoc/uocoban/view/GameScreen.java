    ...
    public void render(float delta) {
        ...
        if (!gameController.isLevelDeadlocked() && !gameController.hasLostGame() && !gameController.hasLostLevel()) {
            ...
            if (loaded) {
                ...
                game.font.draw(game.batch, "Lives " + gameController.getLives(), 25, 80);
                game.font.draw(game.batch, "Score " + gameController.getScore(), 25, 40);
                //game.font.draw(game.batch, "Elementos " + gameController.getLevel().getMapItemList().size(), 25, 200);
